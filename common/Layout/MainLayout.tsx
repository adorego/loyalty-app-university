...
const MainLayout = ({children,...props}:MainLayoutProps) =>{
        ...
        return(
            ...
            <Head>
                ...
                <meta property="og:image" itemProp="image" content={'https://loyaltyapp.com.py/images/social_image.png'} key="ogimage" />
                <meta property="og:type" content="website" />
                <meta property="og:updated_time" content="1440432930" />
                <meta property="og:site_name" content={"LoyaltyApp, Innovación en la Educación"} key="ogsitename" />
